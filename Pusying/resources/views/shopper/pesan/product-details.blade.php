					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-4">
							<div id="similar-product" class="carousel slide" data-ride="carousel">
								<img src="{{ Storage::url('public/products/').$products->gambar }}" alt="" height="300" width="300" />
							</div>
						...
						<div class="col-sm-4">
							...
							<form method="post" action="{{ route('pesanact', $products->id) }}" method="POST"" >
								...
								<p1>Web ID: 1089772</p1>
								
								<span>
									<span>RP. {{ number_format($products->harga)}}</span>							
								</span>
								<p>
									<h3>Jumlah Stock : {{$products->stok}}</h3> 
								</p>
								<p>
									<h3>Deskripsi: {{$products->keterangan}}</h3> 
								</p>
