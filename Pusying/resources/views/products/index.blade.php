              ...
              <div class="mdc-card table-responsive">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-left">{{ $products->nama_barang }}</td>
                      <td class="text-center">{!! $products->harga !!}</td>
                      <td class="text-center">{!! $products->stok !!}</td>
                      <td class="text-center">{!! $products->keterangan !!}</td>
                      <td class="text-center">{!! $products->kategori !!}</td>
